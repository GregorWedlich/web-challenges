...
// log price by fetching the button by his class and use the click event to log the bname and price
const buyButton = newProduct.querySelector(".product__buy-button");
